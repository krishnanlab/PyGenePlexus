...
def save_results(gp, outdir, zip_output, overwrite):
    ...
    outdir = _suffix_dir(outdir, overwrite=overwrite)
...
def _suffix_dir(path, idx=0, overwrite=False):
...
def main():
    ...
    save_results(gp, normexpand(args.output_dir), args.zip_output, args.overwrite)
