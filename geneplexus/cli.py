...
def save_results(gp, outdir, zip_output, overwrite, skip_mdl_sim, tmp_log_path, file_handler):
    ...
    Args:
        ...
        skip_mdl_sim: Whether or not to skip the computation of model
            similarities with GO and DisGeNet. This option is not yet available
            for custom networks.
        tmp_log_path: Temporary run log path, to be moved to the result dir.
        file_handler: File handler to be closed.
