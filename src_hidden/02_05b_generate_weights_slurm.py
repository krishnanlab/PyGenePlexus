...
for idx, acombo in enumerate(combos):
    if idx in [450,451,452,453,454,455,456,457]:
        print(acombo)
...
for idx, acombo in enumerate(combos):
    if idx in [450,451,452,453,454,455,456,457]:
        ...
        mylist.append('#SBATCH --time=12:50:00')
        ...
        mylist.append('python 02_05a_generate_weights.py -n %s -f %s -g %s -stm %i -spm %i'%(acombo[0],acombo[1],acombo[2],acombo[3],acombo[4]))
